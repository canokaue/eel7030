;Programa  MOSTRA1.asm 
		   ...
		   ATRASO	EQU	030H				;define um endereço QUALQUER para o vetor de atraso
...
VOLTA:	   MOV  A,R3						;joga n+1 no acumulador
		   ...
		   MOV ATRASO,#0FFH					;PÕE UM NÚMERO GIGANTE NO ENDEREÇO DO ATRASO
		   CALL DELAY						;chama delay

		   DJNZ	R3,VOLTA					;verifica se já não foram os 9 digitos
		   JMP  $							;em caso afirmativo, para de rodar
 
DELAY: 	   DJNZ	ATRASO,DELAY				;fica decrementando O NÚMERO DO END. DE ATRASO para perder tempo
